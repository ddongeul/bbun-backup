...
public class InsertUser extends AsyncTask<String, Void, String>  {
    ...
    protected String doInBackground(String... params) {
        ...
        String gradeNumber = params[5];
        String email = params[6];
        String StudentNumber = params[7];

        //접근하고자 하는 서버 url
        String serverURL = params[0];

        String postParameters = "account="+account+"&password="+password+"&name="+name+"&department="+department+"&gradeNumber="+gradeNumber+
