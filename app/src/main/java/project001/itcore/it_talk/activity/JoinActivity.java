...
public class JoinActivity extends AppCompatActivity {
    private EditText editText_id, editText_password, editText_passwordCheck, editText_name, editText_department,
            editText_studentNumber ,editText_email;
    //private EditText editText_id, editText_password, editText_passwordCheck, editText_name, editText_nickname;
    private TextView textView_id, textView_password, textView_passwordCheck, textView_name, textview_departmentresult,
            textview_studentnumberresult, textview_graderesult, textView_email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_studentNumber = findViewById(R.id.edittext_studentnumber);
        ...
        textview_departmentresult = findViewById(R.id.textview_departmentresult);
        textview_studentnumberresult = findViewById(R.id.textview_studentnumberresult);
        textview_graderesult = findViewById(R.id.textview_graderesult);
 ...
 */
        ...
        final String [] data = getResources().getStringArray(R.array.department);
        ...
        btn_join.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String StudentNumber = editText_studentNumber.getText().toString();

                String gradeNumber = grade;
...
*/
                    ...
                    Toast.makeText(getApplicationContext(), gradeNumber , Toast.LENGTH_SHORT).show();

                    Log.d("log d", department);
                    Log.d("log d", gradeNumber);
                    Log.d("log d", StudentNumber);

                    //사용자 정보를 서버의 db에 저장시키기 위한 asynctask실행
                    InsertUser insertUser = new InsertUser();
                    insertUser.execute("http://" + IP_ADDRESS + "/bbun/server_php/insertuser.php", account, password, name, department, gradeNumber, email, StudentNumber);
    ...
    private void checkAccount(String account) {
        ...
        //아이디가 양식에 부합하는 경우
            ...
            if (account.length() >= 4 && account.length() <= 16) {
                ...
                doubleCheck.execute("http://" + IP_ADDRESS + "/bbun/server_php/checkaccount.php", account, "account");
            }
    ...
    public void onRadioButtonClicked(View view){
        ...
        switch(view.getId()) {
            case R.id.RadioButton_grade_1:
                if (checked){
                    grade = "1";
                } break;
            case R.id.RadioButton_grade_2:
                if (checked){
                    grade = "2";
                }break;

            case R.id.RadioButton_grade_3:
                if (checked) {
                    grade = "3";
                }break;
            case R.id.RadioButton_grade_4:
                if (checked){
                    grade = "4";
                }
                break;
