...
import static project001.itcore.it_talk.activity.JoinActivity.IP_ADDRESS;

/*서버로 데이터를 전송하거나 서버로부터 데이터를 가져오는 역할을 담당하는 클래스   */
public class HttpRequest extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            URL url = new URL("http://" + IP_ADDRESS + "/bbun/server_php/" + requestAPI);
